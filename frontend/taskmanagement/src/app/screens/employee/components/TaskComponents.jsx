...
export default function TaskComonents(){
  ...
  <div className="flex flex-wrap gap-3 mx-3 mb-2">
    <button className="px-4 py-2 text-sm  bg-indigo-500 rounded-xl text-white
      shadow-lg hover:scale-105 hover:bg-indigo-600
      transition-all duration-300">
      Completed
    </button>

    <button className="px-4 py-2 text-sm bg-pink-500 rounded-xl text-white
      shadow-lg hover:scale-105 hover:bg-pink-600
      transition-all duration-300">
      Testing
    </button>

    <button className="px-4 py-2 text-sm bg-yellow-500 rounded-xl text-white
